...
func chineseMall1() -> [PromptAndResponse] {
    return StoryBuilder()
        ...
        .createNew()
        .p("你好！ 今天能和你一起去购物很开心！你想买点什么呢？", "line1.wav")
        .cr("我想买些新衣服， 也可能买个新电脑", "line2a.wav")
        .wr("我想卖掉我的狗因为她老了", "line2b.wav")
        ...
        .createNew()
        .p("太好了 我们现在去付钱吧", "line11.wav")
        
        .createNew()
        .p("您好 谢谢您光临本店 您感觉还不错嘛", "line12.wav")
        .cr("挺好的 没碰到什么问题 ", "line13a.wav")
        .wr("我觉得我想再买些裤子", "line13b.wav")
        .wr("我害怕在商场购物 我们能回家吗", "line13c.wav")
        
        .createNew()
        .p("太好了 您是付现金还是刷卡", "line14.wav")
        .cr("我刷卡", "line15a.wav")
...
func chineseMall2() -> [PromptAndResponse] {
    return StoryBuilder()
        ...
        .createNew()
        .p("我也是 你平时最常用什么科技产品", "line20.wav")
        .cr("我的手机 电视和我的笔记本电脑", "line21a.wav")
        .wr("勺子 碗 和 叉子", "line21b.wav")
        .wr("狗链 狗玩具和橡皮筋", "line21c.wav")
        
        .createNew()
        .p("你是说你想要个新电脑来着 对吧 你现在的电脑有什么问题吗", "line22.wav")
